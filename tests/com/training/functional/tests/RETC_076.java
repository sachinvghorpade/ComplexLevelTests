...
public class RETC_076 {
	...
	public void setUp() throws Exception {
		...
		test = report.startTest("Test Case name: RETC_076");
		// open the browser
		driver.get(baseUrl);
		...
		screenShot.captureScreenShot("RETC_076_Pre-Condition2_Admin_Login_Success");
	}
	...
	public void Functional_Test_RETC_076(String userName,String email,String firstName,String lastName,String webSite,String password,String role) throws Exception {
		...
		String actualResult=add_Multiple_Users_POM.gettextMessageNewUserCreated();
		...
		screenShot.captureScreenShot("RETC_076_Step12_Newusercreated"+userName);		
